...
/**@type {Array<string>} */
exports.developers = ["pokem9n"];

exports.ignoreRooms = [];

exports.level = [];
//Enable level feature in rooms
...
exports.allowModeration = { "groupchat-truthuntold-test": true };
